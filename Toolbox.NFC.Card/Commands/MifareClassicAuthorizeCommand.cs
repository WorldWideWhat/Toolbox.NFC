...
namespace Toolbox.NFC.Card.Commands
{
    public sealed class MifareClassicAuthorizeCommand : ApduCommand
    {
        public MifareClassicAuthorizeCommand(int sector, KeyType keyType, ReaderType reader)
        {
            ...
            {
                ReaderType.Omnikey => new Reader.Driver.Omnikey.MifareClassicAuthorizeCommand(keyType, sector),
                _ => new ApduCommand(0xFF, 0x86, 0x00, 0x00, new byte[] { 0x01, 0x00, (byte)(sector * 4), (byte)keyType, 0x00 }),
            };
